...
('B1001', 'HOOPS 2.0 MID SHOES', 420.00, 'BasketBlack1boys.jpg', 'black', 10, 'basketball', 'MID TOP STYLE FOR YOUNG HOOPS FANS.', 'These kids basketball-inspired shoes have a synthetic nubuck upper and a textile lining to provide durable comfort for active feet. 3-Stripes and a rubber cupsole give the shoes classic hoops style.'), 
('B1002', 'DAME 5 SHOES', 500.00, 'Basket1Blackmen.jpg', 'black', 10, 'basketball', 'B-BALL SHOES BUILT FOR DAMIAN LILLARDS SIGNATURE GAME.','Made to play fresh out of the box, these low top basketball shoes are designed for Damian Lillards signature style. Built with a textile upper, they feature flexible cushioning for lightweight comfort on every step-back jumper. The herringbone outsole lets you change directions on a dime.
...
('B1003', 'HOOPS 2.0 MID SHOES', 420.00, 'BasketWhite1boys.jpg', 'white', 10, 'basketball', 'MID TOP STYLE FOR YOUNG HOOPS FANS.', 'These kids basketball-inspired shoes have a synthetic nubuck upper and a textile lining to provide durable comfort for active feet. 3-Stripes and a rubber cupsole give the shoes classic hoops style.'), 
('B1004', 'DAME 5 SHOES', 500.00, 'Basket1Whitemen.jpg', 'white', 10, 'basketball', 'B-BALL SHOES BUILT FOR DAMIAN LILLARDS SIGNATURE GAME.', 'Made to play fresh out of the box, these low top basketball shoes are designed for Damian Lillards signature style. Built with a textile upper, they feature flexible cushioning for lightweight comfort on every step-back jumper. The herringbone outsole lets you change directions on a dime.
Lightweight cushioning
Bounce cushioning provides enhanced comfort and flexibility
Classic comfort
French terry lining for a soft feel and a throwback look
...
('F1001', 'ADIDAS SAMBA CLASSIC', 780.00, 'women/Foot1Black.jpg', 'black', 10, 'football', '', 
'When it comes to the construction of the Adidas Samba Classic boot, it has been built to last. Starting with the upper, Adidas made use of a full grain synthetic material. This material can feel quite stiff from out of the box but becomes very soft once broken in. 
Additionally, the forefoot and the toe box are covered with a thick suede material. This is to avoid abrasion as well as to provide protection for the foot. 
The football boot also features a tongue and a central lacing system for adjustability and to create the best fit possible. An additional lace hole is present to provide a more secure fit. 
The insoles are non-removable and are made from die-cut Ethylene Vinyl Acetate (EVA) to ensure comfort. An arch support foam has been integrated into the insole, as well. 
To provide a good grip on indoor surfaces, the outsole is made from gum rubber. It has a non-marking feature which is ideal for indoor courts'),

('F1002', 'X TANGO 18.4 INDOOR BOOTS', 198.00, 'Fmen/Foot1White.jpg', 'white', 10, 'football', 'BULLET SPEED, SCULPTED FOR THE SPEED MERCHANT.', 
'Sculpted for speed, these lightweight football boots are optimised for indoor play. A synthetic upper offers a snug, supportive fit, while the rubber outsole provides superb traction on flat surfaces. 
Supportive comfort 
...
('F1003', 'X TANGO 18.4 INDOOR BOOTS', 198.00, 'Fmen/Foot1Yellow.jpg', 'yellow', 10, 'football', 'BULLET SPEED, SCULPTED FOR THE SPEED MERCHANT.', 
...
('F1004', 'X 18.2 FIRM GROUND BOOTS', 850.00, 'Fmen/Foot2Black.jpg', 'black', 10, 'football', 'LIGHTWEIGHT BOOTS RESERVED FOR PLAYERS WHO RUN ON FEARLESSNESS.', 
...
('F1005', 'ADIDAS X 17.1 FIRM GROUND', 600.00, 'Fwomen/Foot2Black.jpg', 'black', 10, 'football', '', 
...
('F1006', 'X 18.2 FIRM GROUND BOOTS', 850.00, 'Fmen/Foot2White.jpg', 'white', 10, 'football', 'LIGHTWEIGHT BOOTS RESERVED FOR PLAYERS WHO RUN ON FEARLESSNESS.', 
'If you can supercharge your game while your rivals are running on empty, you are cleared to fly in X. The thin mesh upper on these ultralight football boots delivers a minimal feel and a natural touch. The outsole has two different stud shapes to assist with quick stops and starts on firm ground. A snug, supportive fit and low-cut collar combine to lock you in for the ride. 
...
('F1007', 'X 18.2 FIRM GROUND BOOTS', 850.00, 'Fmen/Foot2Yellow.jpg', 'yellow', 10, 'football', 'LIGHTWEIGHT BOOTS RESERVED FOR PLAYERS WHO RUN ON FEARLESSNESS.', 
'If you can supercharge your game while your rivals are running on empty, you are cleared to fly in X. The thin mesh upper on these ultralight football boots delivers a minimal feel and a natural touch. The outsole has two different stud shapes to assist with quick stops and starts on firm ground. A snug, supportive fit and low-cut collar combine to lock you in for the ride. 
...
('F1008', 'X TANGO 18.1 TRAINERS', 300.00, 'Fmen/Foot3Blue.jpg', 'blue', 10, 'football', 'LIVE LIFE AT LIGHT SPEED.', 
'Sculpted for speed, fashioned for the street. These football trainers share the lightweight comfort and distinctive silhouette of their on-pitch counterparts. The thin mesh upper is fully breathable, and a layer of responsive cushioning charges every stride to keep you one step ahead. '),

('F1009', 'ADIDAS ACE 17.1 FIRM GROUND', 650.00, 'Fwomen/Foot3Blue.jpg', 'blue', 10, 'football', 'ADIDAS ACE 17.1 FIRM GROUND', 
'Building from the previous football boot model, there were several changes showcased into the Adidas Ace 17.1 Firm Ground football boots. This model features a women and men’s version as well. 
...
('F1010', 'X TANGO 18.1 TRAINERS', 300.00, 'Fmen/Foot3White.jpg', 'white', 10, 'football', 'LIVE LIFE AT LIGHT SPEED.', 
'Sculpted for speed, fashioned for the street. These football trainers share the lightweight comfort and distinctive silhouette of their on-pitch counterparts. The thin mesh upper is fully breathable, and a layer of responsive cushioning charges every stride to keep you one step ahead. '),

('F1011', 'X TANGO 18.1 TRAINERS', 300.00, 'Fmen/Foot3Yellow.jpg', 'yellow', 10, 'football', 'LIVE LIFE AT LIGHT SPEED.', 
'Sculpted for speed, fashioned for the street. These football trainers share the lightweight comfort and distinctive silhouette of their on-pitch counterparts. The thin mesh upper is fully breathable, and a layer of responsive cushioning charges every stride to keep you one step ahead. '),

('F1012', 'PUREBOOST GO SHOES', 500.00, 'Fmen/Foot4Blue.jpg', 'blue', 10, 'football', 'ADAPTIVE RUNNING SHOES MADE FOR CITY STREETS.', 
...
('F1013', 'PUREBOOST GO SHOES', 500.00, 'Fmen/Foot4Gred.jpg', 'gred', 10, 'football', 'ADAPTIVE RUNNING SHOES MADE FOR CITY STREETS.', 
'Built to handle curbs, corners and uneven sidewalks, these natural running shoes have an expanded landing zone and a heel plate for added stability. A lightweight and stretchy knit upper supports your native stride. Energised cushioning works with the flexible outsole to give you a smooth and comfortable ride. '),

('F1014', 'PUREBOOST GO SHOES', 500.00, 'Fmen/Foot4White.jpg', 'white', 10, 'football', 'ADAPTIVE RUNNING SHOES MADE FOR CITY STREETS.', 
'Built to handle curbs, corners and uneven sidewalks, these natural running shoes have an expanded landing zone and a heel plate for added stability. A lightweight and stretchy knit upper supports your native stride. Energised cushioning works with the flexible outsole to give you a smooth and comfortable ride. '),

('F1015', 'ADIDAS NEMEZIZ 17.3 FIRM GROUND', 400.00, 'Fwomen/Foot4White.jpg', 'white', 10, 'football', 'ADAPTIVE RUNNING SHOES MADE FOR CITY STREETS.', 
'The Adidas Nemeziz 17.1 FG features the new Agility Bandage on the upper as well as the Dual Lock Collar construction around the ankle to provide good lockdown. The 360 Torsion Tape molds with the shape of the foot providing comfort right out of the box. 
...
('F1016', 'X 18.1 FIRM GROUND BOOTS', 900.00, 'Fmen/Foot5Red.jpg', 'red', 10, 'football', 'LIGHTWEIGHT BOOTS RESERVED FOR PLAYERS WHO RUN ON FEARLESSNESS.', 
...
('F1017', 'X 18.1 FIRM GROUND BOOTS', 900.00, 'Fmen/Foot5White.jpg', 'white', 10, 'football', 'LIGHTWEIGHT BOOTS RESERVED FOR PLAYERS WHO RUN ON FEARLESSNESS.', 
'If you can supercharge your game while your rivals are running on empty, you are cleared to fly in X. The thin mesh upper on these ultralight football boots delivers a minimal feel and a natural touch, while the outsole is perforated to shed weight. A low-cut collar and moulded heel combine to lock you in for the ride. '),

('F1018', 'ADIDAS NEMEZIZ 17.1 FIRM GROUND', 750.00, 'Fwomen/Foot5White.jpg', 'white', 10, 'football', '', 
'The Adidas Nemeziz 17.3 features a synthetic upper material called the Agility Mesh. This soft and flexible mesh-based material is covered by a thin layer of polyurethane similar to other models of the Nemeziz line. 
...
('F1019', 'X 18.3 FIRM GROUND BOOTS', 320.00, 'Fmen/Foot6Red.jpg', 'red', 10, 'football', 'LIGHTWEIGHT BOOTS RESERVED FOR PLAYERS WHO RUN ON FEARLESSNESS.', 
'If you can supercharge your game while your rivals are running on empty, you are cleared to fly in X. The thin mesh upper on these ultralight football boots delivers a minimal feel and a natural touch, while the outsole is perforated to shed weight. A low-cut collar and moulded heel combine to lock you in for the ride. '),

('F1020', 'X 18.3 FIRM GROUND BOOTS', 320.00, 'Fmen/Foot6White.jpg', 'white', 10, 'football', 'LIGHTWEIGHT BOOTS RESERVED FOR PLAYERS WHO RUN ON FEARLESSNESS.', 
'If you can supercharge your game while your rivals are running on empty, you are cleared to fly in X. The thin mesh upper on these ultralight football boots delivers a minimal feel and a natural touch, while the outsole is perforated to shed weight. A low-cut collar and moulded heel combine to lock you in for the ride. '),

('F1021', 'ADIDAS ACE 17.3 FIRM GROUND', 320.00, 'Fwomen/Foot6White.jpg', 'white', 10, 'football', '', 
...
('F1022', 'X TANGO 18.3 INDOOR BOOTS', 320.00, 'Fmen/Foot7Black.jpg', 'black', 10, 'football', 'LIGHTWEIGHT BOOTS RESERVED FOR PLAYERS WHO RUN ON FEARLESSNESS.', 
'If you can supercharge your game while your rivals are running on empty, you are cleared to fly in X. The thin mesh upper on these ultralight football boots delivers a minimal feel and a natural touch, while the outsole is perforated to shed weight. A low-cut collar and moulded heel combine to lock you in for the ride. '),

('F1023', 'ADIDAS NERMEZIZ 17+ 360 AGILITY FIRM GROUND', 320.00, 'Fwomen/Foot7Black.jpg', 'black', 10, 'football', '', 
'The upper of the Adidas Nemeziz 17+ 360 Agility uses the new Agility Knit 2.0 in the forefoot and heel areas. It is an interlocking yarn structure that provides a soft touch on the ball. 
...
('F1024', 'X TANGO 18.3 INDOOR BOOTS', 320.00, 'Fmen/Foot7White.jpg', 'white', 10, 'football', 'LIGHTWEIGHT BOOTS RESERVED FOR PLAYERS WHO RUN ON FEARLESSNESS.', 
'If you can supercharge your game while your rivals are running on empty, you are cleared to fly in X. The thin mesh upper on these ultralight football boots delivers a minimal feel and a natural touch, while the outsole is perforated to shed weight. A low-cut collar and moulded heel combine to lock you in for the ride. '),

('F1025', 'ADIDAS X 17.2 FIRM GROUND', 320.00, 'Fwomen/Foot8Black.jpg', 'black', 10, 'football', '', 
'The Adidas X 17.2 features the TechFit construction upper. This soft material provides a snug fit and comfortable feel right out of the box. 
...
('F1026', 'X 17.2 FIRM GROUND BOOTS', 420.00, 'Fmen/Foot8White.jpg', 'white', 10, 'football', 'EXPLOSIVE QUICKNESS FOR THE SPEED DEMON', 
'Make your speed the opposition is worst enemy in these lightweight football boots. A supportive four-way-stretch upper fits like a sock, while the mid-cut design delivers stability at high speeds. Breathable mesh helps you stay cool when you are flying around the pitch. The outsole is geared for explosive acceleration on firm ground. '),

('F1027', 'ADIDAS NEMEZIZ 17.4 FIRM GROUND', 600.00, 'Fwomen/Foot9Blue.jpg', 'blue', 10, 'football', '', 
'Living up to the Messi name, the Nemeziz 17.4 Firm Ground is meant to deliver unstoppable agility to the playground. Equipped with innovative technologies that make it unique on the pitch, this football boot is ready to give the competition a run for their money. 
...
('F1028', 'X TANGO 17.3 TURF BOOTS', 245.00, 'Fmen/Foot9Gold.jpg', 'gold', 10, 'football', 'EXPLOSIVE QUICKNESS FOR THE SPEED DEMON', 
'Make your speed the opposition is worst enemy in these lightweight football boots. A supportive four-way-stretch upper fits like a sock, while the mid-cut design delivers stability at high speeds. Breathable mesh helps you stay cool when you are flying around the pitch. The outsole is geared for explosive acceleration on firm ground. '),



('R1001', 'ALPHAEDGE 4D SHOES', 1400.00, 'Rmen/Run1Black.jpg', 'black', 10, 'running', 'LIGHTWEIGHT RUNNING SHOES DESIGNED TO GIVE ATHLETES AN EDGE.', 
...
('R1002', 'ADIZERO PRIME SHOES', 720.00, 'Rwomen/Run1Black.jpg', 'black', 10, 'running', 'LIGHTWEIGHT RUNNING SHOES WITH ENERGY-RETURNING CUSHIONING', 
'Built for fast training and racing, these neutral running shoes have a lightweight knit upper that offers long-lasting support and comfort. A custom lacing system locks down the fit. A flexible outsole works with the responsive midsole cushioning to give you a smooth ride. '),
...
('R1004', 'ULTRABOOST 19 SHOES', 850.00, 'Rmen/Run2Black.jpg', 'black', 10, 'running', 'SHOES WITH ENDLESS ENERGY FOR LONG CITY RUNS.', 
'Push yourself further, faster, in running shoes that deliver tuned energy to every stride. A breathable mesh upper features zoned areas of support for added lateral stability. Carbon 4D technology in the midsole offers a snappy ride and controlled energy return. The durable rubber outsole provides superior grip. '),

('R1005', 'ALPHAEDGE 4D SHOES', 1200.00, 'Rwomen/Run2Black.jpg', 'black', 10, 'running', 'LIGHTWEIGHT RUNNING SHOES DESIGNED TO GIVE ATHLETES AN EDGE.', 
'Push yourself further, faster, in running shoes that deliver tuned energy to every stride. A breathable mesh upper features zoned areas of support for added lateral stability. Carbon 4D technology in the midsole offers a snappy ride and controlled energy return. The durable rubber outsole provides superior grip. '),

('R1006', 'ULTRABOOST 19 SHOES', 850.00, 'Rmen/Run2Blue.jpg', 'blue', 10, 'running', 'SHOES WITH ENDLESS ENERGY FOR LONG CITY RUNS', 
'Push yourself further, faster, in running shoes that deliver tuned energy to every stride. A breathable mesh upper features zoned areas of support for added lateral stability. Carbon 4D technology in the midsole offers a snappy ride and controlled energy return. The durable rubber outsole provides superior grip. '),

('R1007', 'ULTRABOOST 19 SHOES', 850.00, 'Rmen/Run2Red.jpg', 'red', 10, 'running', 'SHOES WITH ENDLESS ENERGY FOR LONG CITY RUNS', 
'Push yourself further, faster, in running shoes that deliver tuned energy to every stride. A breathable mesh upper features zoned areas of support for added lateral stability. Carbon 4D technology in the midsole offers a snappy ride and controlled energy return. The durable rubber outsole provides superior grip. '),

('R1008', 'ULTRABOOST 19 SHOES', 850.00, 'Rmen/Run2White.jpg', 'white', 10, 'running', 'SHOES WITH ENDLESS ENERGY FOR LONG CITY RUNS', 
'Push yourself further, faster, in running shoes that deliver tuned energy to every stride. A breathable mesh upper features zoned areas of support for added lateral stability. Carbon 4D technology in the midsole offers a snappy ride and controlled energy return. The durable rubber outsole provides superior grip. '),

('R1009', 'ALPHAEDGE 4D SHOES', 1200.00, 'Rwomen/Run2White.jpg', 'white', 10, 'running', 'LIGHTWEIGHT RUNNING SHOES DESIGNED TO GIVE ATHLETES AN EDGE.', 
'Push yourself further, faster, in running shoes that deliver tuned energy to every stride. A breathable mesh upper features zoned areas of support for added lateral stability. Carbon 4D technology in the midsole offers a snappy ride and controlled energy return. The durable rubber outsole provides superior grip. '),

('R1010', 'ULTRABOOST SHOES', 750.00, 'Rmen/Run3Blue.jpg', 'blue', 10, 'running', 'ADAPTIVE RUNNING SHOES WITH ENERGISED CUSHIONING.', 
'Built for comfort and performance. These men is running shoes have a breathable knit upper with ventilation in key sweat zones to help keep feet cool and dry. A flexible outsole moves in harmony with responsive cushioning for a smooth, energy-filled ride. '),

('R1011', 'ADIZERO PRIME LTD SHOES', 720.00, 'Rwomen/Run3Blue.jpg', 'blue', 10, 'running', 'ENERGY-RETURNING SHOES FOR FAST TRAINING.', 
'Made for fast training on the road or the track, these neutral running shoes have a lightweight knit upper that adapts to the shape of your foot as you run. The dual-lacing system allows you to personalise the fit for precise lockdown. Responsive cushioning keeps your stride energised. '),

('R1012', 'SOLABOOST 19 SHOES', 650.00, 'Rmen/Run4Black.jpg', 'black', 10, 'running', 'STABILITY RUNNING SHOES WITH TARGETED SUPPORT AND DUAL-DENSITY CUSHIONING.', 
'There is no such thing as an ordinary run. These men is stability shoes provide targeted support and optimal comfort for everyday long-distance running. Inspired by NASA technology, the mesh upper has stitched-in areas of reinforcement for precisely calibrated support. Dual-density cushioning is firmer on the medial side to guide your foot for a smooth, confident ride. 
...
('R1013', 'SOLABOOST 19 SHOES', 650.00, 'Rmen/Run4White.jpg', 'white', 10, 'running', 'STABILITY RUNNING SHOES WITH TARGETED SUPPORT AND DUAL-DENSITY CUSHIONING.', 
'MThere is no such thing as an ordinary run. These men is stability shoes provide targeted support and optimal comfort for everyday long-distance running. Inspired by NASA technology, the mesh upper has stitched-in areas of reinforcement for precisely calibrated support. Dual-density cushioning is firmer on the medial side to guide your foot for a smooth, confident ride. 
...
('R1014', 'ULTRANOOST ALL TERRAIN LTD SHOES', 720.00, 'Rwomen/Run4Yellow.jpg', 'yellow', 10, 'running', 'WEATHERPROOF RUNNING SHOES WITH ENERGISED CUSHIONING.', 
'Designed for all-weather running, these shoes have a knit upper with a water-repellent coating for protection in wet conditions. A high collar acts as an ankle splash guard, and the all-terrain outsole delivers traction on wet and uneven surfaces. The women is-specific arch offers gentle compression for a uniquely supportive feel. '),

('R1015', 'SENSEBOOST GO SHOES', 500.00, 'Rmen/Run5Black.jpg', 'black', 10, 'running', 'FORM-FITTING RUNNING SHOES FOR EVERYDAY PRACTICE AND PLAY.', 
'Built for a locked-down feel, these junior is running shoes feature a form-fitting textile upper that offers support in key zones as you move. The cushioned Boost midsole provides energy return with each stride. A soft rubber outsole offers superior grip on the track.'),

('R1016', 'SENSEBOOST GO SHOES', 500.00, 'Rmen/Run5Blue.jpg', 'blue', 10, 'running', 'FORM-FITTING RUNNING SHOES FOR EVERYDAY PRACTICE AND PLAY.', 
'Built for a locked-down feel, these junior is running shoes feature a form-fitting textile upper that offers support in key zones as you move. The cushioned Boost midsole provides energy return with each stride. A soft rubber outsole offers superior grip on the track.'),

('R1017', 'SENSEBOOST GO SHOES', 500.00, 'Rmen/Run5White.jpg', 'white', 10, 'running', 'FORM-FITTING RUNNING SHOES FOR EVERYDAY PRACTICE AND PLAY.', 
'Built for a locked-down feel, these junior is running shoes feature a form-fitting textile upper that offers support in key zones as you move. The cushioned Boost midsole provides energy return with each stride. A soft rubber outsole offers superior grip on the track.'),

('R1018', 'AM 4 RTN', 600.00, 'Rwomen/Run5White.jpg', 'white', 10, 'running', 'CLOUDFOAM RACER TR SHOES', 
'Inspired by trail runners, ready for the playground. These kids shoes are built for fun adventures, with a two-tone knit upper and a rugged look. cloudfoam cushioning adds comfort.'),

('R1019', 'ALPHABOUNCE+RUN PARLEY SHOES', 450.00, 'Rmen/Run6Black.jpg', 'black', 10, 'running', 'RUNNING SHOES MADE WITH YARN SPUN FROM RECYCLED PLASTIC.', 
'Choose to be better every day. These running shoes feature forging in key areas to deliver reinforcement and an unrestricted fit. A wide forefoot platform supports multidirectional movement. The shoes are made with Parley Ocean Plastic™ yarn thats sourced from recycled plastic.'),

('R1020', 'ADIZERO BOSTON 8 WIDE SHOES', 480.00, 'Rwomen/Run6Pink.jpg', 'pink', 10, 'running', 'RESPONSIVE PERFORMANCE FOR RACE DAY AND BEYOND.', 
'These race-ready shoes deliver maximum comfort from the starting gun to the finish line. Ideal for long-distance training, they feature responsive Boost cushioning for the highest level of energy return. A stability rail helps guide your stride, and the engineered mesh upper locks down your heel and midsole for a secure fit. The rubber Stretchweb outsole is inspired by adidas fastest running shoe for a smooth, flexible ride.'),

('R1021', 'ULTRABOOST S&L SHOES', 750.00, 'Rmen/Run7Blue.jpg', 'blue', 10, 'running', 'LEATHER RUNNING SHOES WITH ENERGISED CUSHIONING.', 
'Ultraboost comfort and performance in premium leather. These womens running shoes are designed with a soft leather upper. A flexible outsole moves in harmony with responsive cushioning for a smooth, energy-filled ride.'),

('R1022', 'ULTRABOOST 9 SHOES', 720.00, 'Rwomen/Run7Blue.jpg', 'blue', 10, 'running', 'SHOES WITH ENDLESS ENERGY FOR LONG CITY RUNS.', 
'Running reinvented. These high-performance neutral running shoes deliver unrivalled comfort and energy return. The lightweight and propulsive shoes have a seamless knit upper thats engineered with motion weave technology to provide stretch while also holding your foot in place while you run. The second-skin fit follows the shape of your foot to reduce pressure points. '),

('R1023', 'ULTRABOOST S&L SHOES', 750.00, 'Rmen/Run7Gred.jpg', 'gred', 10, 'running', 'LEATHER RUNNING SHOES WITH ENERGISED CUSHIONING.', 
'Ultraboost comfort and performance in premium leather. These womens running shoes are designed with a soft leather upper. A flexible outsole moves in harmony with responsive cushioning for a smooth, energy-filled ride. '),

('R1024', 'ULTRABOOST 9 SHOES', 720.00, 'Rwomen/Run7Pink.jpg', 'pink', 10, 'running', 'SHOES WITH ENDLESS ENERGY FOR LONG CITY RUNS.', 
'Running reinvented. These high-performance neutral running shoes deliver unrivalled comfort and energy return. The lightweight and propulsive shoes have a seamless knit upper thats engineered with motion weave technology to provide stretch while also holding your foot in place while you run. The second-skin fit follows the shape of your foot to reduce pressure points. '),

('R1025', 'SOLAR DRIVE 19 SHOES', 450.00, 'Rmen/Run8Black.jpg', 'black', 10, 'running', 'BREATHABLE RUNNING SHOES WITH A STABLE FEEL.', 
'Feel confident on your daily run. These womens shoes have a breathable mesh upper thats designed for an irritation-free fit. A Solar Propulsion Rail helps to guide the foot from touchdown to toe-off. Responsive cushioning returns energy to your stride. 
...
('R1026', 'DURAMO 9 SHOES', 260.00, 'Rwomen/Run8Black.jpg', 'black', 10, 'running', 'CUSHIONED RUNNING SHOES WITH A BREATHABLE MESH UPPER.', 
'These mens versatile running shoes are ideal for the treadmill or the trail. They feature a two-layer mesh upper for breathability and a seamless print overlay for additional support. Pillow-soft Cloudfoam cushions every stride, while the durable outsole provides long-lasting wear. '),

('R1027', 'SOLAR DRIVE 19 SHOES', 450.00, 'Rmen/Run8Blue.jpg', 'blue', 10, 'running', 'BREATHABLE RUNNING SHOES WITH A STABLE FEEL.', 
'Feel confident on your daily run. These womens shoes have a breathable mesh upper thats designed for an irritation-free fit. A Solar Propulsion Rail helps to guide the foot from touchdown to toe-off. Responsive cushioning returns energy to your stride. 
...
('R1028', 'DURAMO 9 SHOES', 260.00, 'Rwomen/Run8Blue.jpg', 'blue', 10, 'running', 'CUSHIONED RUNNING SHOES WITH A BREATHABLE MESH UPPER.', 
'These mens versatile running shoes are ideal for the treadmill or the trail. They feature a two-layer mesh upper for breathability and a seamless print overlay for additional support. Pillow-soft Cloudfoam cushions every stride, while the durable outsole provides long-lasting wear. '),

('R1029', 'PUREBOOST DPR SHOES', 600.00, 'Rmen/Run9Black.jpg', 'black', 10, 'running', 'LIGHTWEIGHT RUNNING SHOES WITH ENERGISED CUSHIONING.', 
...
('R1030', 'PUREBOOST DPR SHOES', 600.00, 'Rmen/Run9Gred.jpg', 'gred', 10, 'running', 'LIGHTWEIGHT RUNNING SHOES WITH ENERGISED CUSHIONING.', 
'City running means constantly adjusting to changing conditions. These shoes are designed with a close-to-the-ground feel to help you stay in tune with your surroundings. An expanded landing zone increases stability during lateral movements. The knit upper adapts to the shape of your foot as you run, and responsive cushioning keeps you energised. 
...
('R1031', 'ULTRABOOST X 3D SHOES', 920.00, 'Rwomen/Run9Red.jpg', 'red', 10, 'running', 'RUNNING SHOES WITH A WOMEN S-SPECIFIC DESIGN AND RESPONSIVE CUSHIONING.', 
'These shoes were created using motion capture technology to meet the needs of the female runner. A women s-specific arch offers a uniquely supportive feel. The stretchy knit upper adapts to the changing shape of your foot as you run, and responsive cushioning delivers a smooth and energised ride. '),

('R1032', 'PUREBOOST DPR SHOES', 600.00, 'Rmen/Run9Gred.jpg', 'gred', 10, 'running', 'LIGHTWEIGHT RUNNING SHOES WITH ENERGISED CUSHIONING.', 
'City running means constantly adjusting to changing conditions. These shoes are designed with a close-to-the-ground feel to help you stay in tune with your surroundings. An expanded landing zone increases stability during lateral movements. The knit upper adapts to the shape of your foot as you run, and responsive cushioning keeps you energised. 
...
('R1033', 'PUREBOOST DPR SHOES', 600.00, 'Rmen/Run9White.jpg', 'white', 10, 'running', 'LIGHTWEIGHT RUNNING SHOES WITH ENERGISED CUSHIONING.', 
'City running means constantly adjusting to changing conditions. These shoes are designed with a close-to-the-ground feel to help you stay in tune with your surroundings. An expanded landing zone increases stability during lateral movements. The knit upper adapts to the shape of your foot as you run, and responsive cushioning keeps you energised. 
