                            ...
                            <!-- <h5 clas="card-title">Men</h5> -->
                                <div class="row">
                                    <?php
                                         ...
                                         $sql="select * from product where style='lifestyle'".$search;//有where在sql，search sql 不能再有where 换成and
                    ...
                    <div class="row">
                      ...
                      <div class="col-6 col-md">
                        ...
                        <ul class="list-unstyled text-small">
                          ...
                          <li><a class="text-muted" href="adidasTrainning.php">Training</a></li>
                        </ul>
                      </div>
                      <div class="col-6 col-md">
                        <h5>Company Info</h5>
